# lets create a board project to represent the minesweeper game
...
class Board:
    ...
    def assign_values_to_board(self):
        # now that we have the bombs planted, let's assign a number 0-8 for all the empty space, which
    ...
    def dig(self, row, col):
        ...
        self.dug.add((row, col)) # keep track what we dug here
        ...
        # if our initital dig didn't hit a bomb, we shouldn't hit a bomb there
        return True
